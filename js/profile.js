...
// Helper to persist user to the same storage where it originated
    ...
    avatarInputEl.addEventListener('change', async function () {
        ...
        try {
            ...
            try {
                ...
                alert('Unable to save the image to local storage (quota exceeded). Please try a smaller image or use a different browser.');
            }
        } catch (err) {
